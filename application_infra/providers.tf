...
# preventing token expiration during long Terraform operations (Helm releases, etc.).
# The script handles cross-account role assumption with ExternalId when needed.
locals {
  eks_exec_env = {
